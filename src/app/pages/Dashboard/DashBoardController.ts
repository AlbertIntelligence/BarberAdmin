...
import {DashBoardModelComponent} from './/DashBoardModel';
...
export class DashboardComponent {
  dashBoardModel = new DashBoardModelComponent();
   ...
   idsTicket = [];
   firstNamesTicket: any;
   lastNamesTicket: any;
   idsTicketStandby: any;
   firstNamesTicketStandby: any;
   lastNamesTicketStandby: any;

   idsReservation: any;
   dateReservation: any;
   timeReservation: any;
   firstNamesReservation: any;
   lastNamesReservation: any;
   numberClientWaitingTicketList: number;
   numberClientWaitingReservation: any;
   liveMessage: FormGroup;
...
constructor(private routerLink: Router) {
  ...
  /*
    ...
    this.liveMessage = new FormGroup({
  ...
  //function not used to be remove
  liveMesssage() {
    let model = this;
  ...
  saveAdChanges() {
    const liveMessages = firebase.database().ref('Messages');
    const data = this.liveMessage.value;
